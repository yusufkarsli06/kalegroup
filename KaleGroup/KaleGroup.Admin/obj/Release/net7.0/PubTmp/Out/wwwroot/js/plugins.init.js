...
try {
    ...
    var barChart = new ApexCharts(document.querySelector("#sale-chart"), options2);
    barChart.render();
} catch (error) {
...
try {
    var options = {
        ...
        labels: ["İstinaf", "İcra", "İdare", "Ceza"],
        legend: {
            show: true,
            position: 'bottom',
            offsetY: 0,
    ...
    var donutChart = new ApexCharts(document.querySelector("#top-product-chart"), options);
    donutChart.render();
} catch (error) {
